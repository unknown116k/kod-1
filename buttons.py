...
def loc_button():
    ...
    # Создаем сами кнопки
    loc = types.KeyboardButton('Отправить геопозицию', request_contact=True)
...
def main_menu_buttons(products_from_db):
    ...
    #Слздаем кнопки с продуктами
    all_products = [types.InlineKeyboardButton(text=f'{i[0]}', callback_data=f'{i[2]}')
