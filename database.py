...
#Проверка на наличие пльзователя в базе
def checker(id):
...
def del_cart(user_id):
    ...
    amount = sql.execute('SELECT pr_amount FORM products WHERE pr_name=?;', (pr_name,)).fetchone()
...
sql.execute('INSERT INTO products (pr_name,'
            ...
            'pr_price,'
            'pr_des,'
            'pr_photo) VALUES ("Лаваш", "5000", "27990", "Вкусний сочний",'
